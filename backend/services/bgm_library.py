...
BGM_CATALOG: list[dict] = [
    ...
    # ── Pixabay Top Picks ─────────────────────────────────
    {
        "id": "bgm_epic_cinematic",
        "name": "Epic Cinematic",
        "genre": "orchestral",
        "tags": ["史诗", "冒险", "电影感", "管弦乐"],
        "bpm": 105,
        "duration_sec": 150,
        "mood": ["epic", "adventure", "cinematic"],
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/main-title-epic-cinematic",
        "climax_sections": [{"start_sec": 60, "end_sec": 90, "label": "管弦乐全奏高点"}],
    },
    {
        "id": "bgm_powerful_motivational",
        "name": "Powerful",
        "genre": "orchestral",
        "tags": ["力量", "励志", "史诗", "运动"],
        "bpm": 110,
        "duration_sec": 120,
        "mood": ["powerful", "motivational", "triumphant"],
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/build-up-powerful",
        "climax_sections": [{"start_sec": 60, "end_sec": 90, "label": "高潮"}],
    },
    {
        "id": "bgm_emotional_cinematic",
        "name": "Emotional Cinematic",
        "genre": "ambient",
        "tags": ["情感", "钢琴", "弦乐", "感人"],
        "bpm": 75,
        "duration_sec": 180,
        "mood": ["emotional", "sad", "beautiful"],
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/modern-classical-emotional-cinematic",
        "climax_sections": [{"start_sec": 90, "end_sec": 150, "label": "弦乐高潮"}],
    },
    {
        "id": "bgm_upbeat_rock",
        "name": "Upbeat Rock",
        ...
        "bpm": 140,
        "duration_sec": 120,
        "mood": ["energetic", "driving", "powerful"],
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/rock-upbeat-rock",
        "climax_sections": [{"start_sec": 30, "end_sec": 60, "label": "Drop"}],
    },
    {
        "id": "bgm_cinematic_tension",
        ...
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/build-up-cinematic-tension",
        "climax_sections": [{"start_sec": 90, "end_sec": 120, "label": "释放点"}],
    },
    {
        "id": "bgm_inspirational_uplifting",
        "name": "Inspirational Uplifting",
        "genre": "ambient",
        "tags": ["励志", "上升", "希望", "钢琴"],
        "bpm": 90,
        "duration_sec": 180,
        "mood": ["inspirational", "uplifting", "hopeful"],
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/beautiful-plays-inspirational-uplifting",
        "climax_sections": [{"start_sec": 80, "end_sec": 120, "label": "高潮"}],
    },
    # ── Beat-Sync / 卡点 Action ───────────────────────────
    {
        "id": "bgm_total_war",
        "name": "Total War",
        "genre": "cinematic",
        "tags": ["史诗", "战斗", "卡点", "管弦乐", "高潮"],
        "bpm": 130,
        "duration_sec": 120,
        "mood": ["epic", "battle", "powerful"],
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/adventure-total-war-epic-action-cinematic-trailer-main-513668/",
        "climax_sections": [{"start_sec": 45, "end_sec": 75, "label": "管弦乐高潮"}],
    },
    {
        "id": "bgm_action_dubstep",
        "name": "Action Dubstep",
        "genre": "electronic",
        "tags": ["Dubstep", "卡点", "快切", "电子", "激烈"],
        "bpm": 140,
        "duration_sec": 120,
        "mood": ["intense", "aggressive", "fast"],
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/dubstep-action-453990/",
        "climax_sections": [{"start_sec": 30, "end_sec": 60, "label": "Drop"}],
    },
    {
        "id": "bgm_cinematic_chase",
        "name": "Cinematic Chase",
        "genre": "cinematic",
        "tags": ["追逐", "紧张", "电影感", "卡点"],
        "bpm": 130,
        "duration_sec": 90,
        "mood": ["tension", "chase", "urgent"],
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/sound-effects/musical-cinematic-action-chase-drive-488130/",
        "climax_sections": [{"start_sec": 30, "end_sec": 60, "label": "加速高潮"}],
    },
    {
        "id": "bgm_dark_action",
        "name": "Dark Action",
        ...
        "source": "pixabay",
        "license": "CC0",
        "url": "https://pixabay.com/music/horror-scene-dark-action-519594/",
        "climax_sections": [{"start_sec": 40, "end_sec": 70, "label": "紧张高点"}],
    },
    {
        "id": "bgm_running_free",
        "name": "Running Free",
        ...
        "bpm": 120,
        "duration_sec": 130,
        "mood": ["energetic", "freedom", "driving"],
        "source": "motionarray",
        "license": "CC0",
        "url": "https://motionarray.com/royalty-free-music/running-free-1319381/",
        "climax_sections": [{"start_sec": 45, "end_sec": 75, "label": "副歌高潮"}],
    },
    {
        "id": "bgm_drive_freedom",
        "name": "Drive And Freedom",
        "genre": "electronic",
        "tags": ["电子", "驾驶", "公路", "自由", "卡点"],
        "bpm": 130,
        "duration_sec": 120,
        "mood": ["upbeat", "driving", "happy"],
        "source": "motionarray",
        "license": "CC0",
        "url": "https://motionarray.com/royalty-free-music/drive-and-freedom-965178/",
        "climax_sections": [{"start_sec": 60, "end_sec": 90, "label": "高潮"}],
    },
    # ── Public Domain Classical (Musopen) ─────────────────
    {
        "id": "pd_moonlight_sonata",
        ...
        "bpm": 55,
        "duration_sec": 330,
        "mood": ["melancholic", "contemplative", "dark"],
        "use_case": ["纪录片", "文艺片", "情感段落"],
        "climax_sections": [{"start_sec": 0, "end_sec": 30, "label": "标志性开头三连音"}],
        "source": "musopen",
        "license": "Public Domain",
        "download_url": "https://musopen.org/music/2544-moonlight-sonata/",
        "bundled": False,
    },
    {
        "id": "pd_cello_suite_no1",
        "name": "Cello Suite No.1 - Prelude",
        "name_cn": "大提琴无伴奏第一号前奏曲",
        "composer": "J.S. Bach",
        "genre": "classical",
        "tags": ["大提琴", "巴赫", "经典", "优雅"],
        "bpm": 66,
        "duration_sec": 160,
        "mood": ["dignified", "serene", "pure"],
        "use_case": ["婚礼", "企业宣传", "纪录片"],
        "climax_sections": [{"start_sec": 0, "end_sec": 20, "label": "标志性开场"}],
        "source": "musopen",
        "license": "Public Domain",
        "download_url": "https://musopen.org/music/4731-cello-suite-no1/",
        "bundled": False,
    },
    {
        "id": "pd_nocturne_op9_no2",
        "name": "Nocturne Op.9 No.2",
        "name_cn": "夜曲 Op.9 No.2",
        "composer": "Frederic Chopin",
        "genre": "classical",
        "tags": ["钢琴", "肖邦", "浪漫", "夜曲"],
        "bpm": 60,
        "duration_sec": 270,
        "mood": ["romantic", "sorrowful", "elegant"],
        "use_case": ["婚礼", "文艺片", "Vlog"],
        "climax_sections": [{"start_sec": 90, "end_sec": 150, "label": "旋律最高点"}],
        "source": "musopen",
        "license": "Public Domain",
        "download_url": "https://musopen.org/music/4423-nocturne-op9-no2/",
        "bundled": False,
    },
]
