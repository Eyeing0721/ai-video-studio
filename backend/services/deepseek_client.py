...
- description: 【核心】画面描述，100-250字，必须包含：
  ...
  * 每个角色的精确外貌——不要模板化的"帅气""漂亮"。要真实的人：不对称的五官、皮肤瑕疵、体型特征、旧伤疤痕、牙齿不齐、发型凌乱、岁月痕迹。每个人应该有独特到能在人群中一眼认出的特征。例如不是"一个帅气的年轻人"而是"一个二十出头的男人，颧骨偏高，鼻梁有点歪，右嘴角比左边低使他的笑容永远显得像是在嘲笑什么，黑色短发有几根不听话地翘在头顶，下巴上有一道童年摔伤留下的月牙形疤痕"
